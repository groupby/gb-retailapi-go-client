...
// checks if the ProductDtoPublishTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductDtoPublishTime{}

// ProductDtoPublishTime struct for ProductDtoPublishTime
type ProductDtoPublishTime struct {
	// Timestamp seconds.
...
func (o ProductDtoPublishTime) MarshalJSON() ([]byte, error) {
...
func (o ProductDtoPublishTime) ToMap() (map[string]interface{}, error) {
...
type NullableProductDtoPublishTime struct {
	value *ProductDtoPublishTime
	isSet bool
}

func (v NullableProductDtoPublishTime) Get() *ProductDtoPublishTime {
	return v.value
}

func (v *NullableProductDtoPublishTime) Set(val *ProductDtoPublishTime) {
	v.value = val
	v.isSet = true
}

func (v NullableProductDtoPublishTime) IsSet() bool {
	return v.isSet
}

func (v *NullableProductDtoPublishTime) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductDtoPublishTime(val *ProductDtoPublishTime) *NullableProductDtoPublishTime {
	return &NullableProductDtoPublishTime{value: val, isSet: true}
}

func (v NullableProductDtoPublishTime) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductDtoPublishTime) UnmarshalJSON(src []byte) error {
	v.isSet = true
