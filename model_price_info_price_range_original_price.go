...
// checks if the PriceInfoPriceRangeOriginalPrice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceInfoPriceRangeOriginalPrice{}

// PriceInfoPriceRangeOriginalPrice struct for PriceInfoPriceRangeOriginalPrice
type PriceInfoPriceRangeOriginalPrice struct {
...
func NewPriceInfoPriceRangeOriginalPrice() *PriceInfoPriceRangeOriginalPrice {
	this := PriceInfoPriceRangeOriginalPrice{}
	return &this
}
...
func (o PriceInfoPriceRangeOriginalPrice) MarshalJSON() ([]byte, error) {
...
func (o PriceInfoPriceRangeOriginalPrice) ToMap() (map[string]interface{}, error) {
...
type NullablePriceInfoPriceRangeOriginalPrice struct {
	value *PriceInfoPriceRangeOriginalPrice
	isSet bool
}

func (v NullablePriceInfoPriceRangeOriginalPrice) Get() *PriceInfoPriceRangeOriginalPrice {
	return v.value
}

func (v *NullablePriceInfoPriceRangeOriginalPrice) Set(val *PriceInfoPriceRangeOriginalPrice) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceInfoPriceRangeOriginalPrice) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceInfoPriceRangeOriginalPrice) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceInfoPriceRangeOriginalPrice(val *PriceInfoPriceRangeOriginalPrice) *NullablePriceInfoPriceRangeOriginalPrice {
	return &NullablePriceInfoPriceRangeOriginalPrice{value: val, isSet: true}
}

func (v NullablePriceInfoPriceRangeOriginalPrice) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceInfoPriceRangeOriginalPrice) UnmarshalJSON(src []byte) error {
	v.isSet = true
